      ...
      <div class="container-fluid">
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-6 d-none d-lg-block">
            ...
            <form role="search" action="/" method="get" class="col-11 col-md-8" style="display:flex;justify-content: space-between;">
                  <input id="searchParam" name="searchParam" type="text" class="form-control border-0 bg-transparent" placeholder="Search for more than 20,000 products" />
                  <button class="" type="submit" style="border-radius: 10px;border-style: none;">
          ...
          <div class="col-sm-8 col-lg-3 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            ...
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a id="profile" href="#" class="rounded-circle bg-light p-2 mx-1">
          ...
          <div class="modal-body">
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-6 ml-auto"><span id="name"></span></div>
              </div>
              <div class="row">
                <div class="col-md-6">Username</div>
                <div class="col-md-6 ml-auto"><span id="username"></span></div>
              </div>
              <div class="row">
                <div class="col-md-6">Mobile Number</div>
                <div class="col-md-6 ml-auto"><span id="mobileNumber"></span></div>
              </div>
              <div class="row">
                <div class="col-md-6">Credit Card Number</div>
                <div class="col-md-6 ml-auto"><span id="creditCardNumber"></span></div>
              </div>
